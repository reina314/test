    ...
    while True:
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                cv2.putText(color_image, 'Person', org, font, fontScale, color, thickness)
        ...
        if results.pose_landmarks:
          ...
          image_width, image_height = color_image.shape[1], color_image.shape[0]

          right_shol_x = int(right_shoulder_x * image_width)
          left_shol_x = int(left_shoulder_x * image_width)
          right_shol_y = int(right_shoulder_y * image_height)
          left_shol_y = int(left_shoulder_y* image_height)

          px = (right_shol_x+left_shol_x)//2
          py = (right_shol_y+left_shol_y)//2
